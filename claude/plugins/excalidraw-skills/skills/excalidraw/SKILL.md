...
```bash
cd ~/.claude/plugins/cache/excalidraw-skills/excalidraw/1.0.0/skills/excalidraw/references && uv run python render_excalidraw.py <path-to-file.excalidraw>
```
...
```bash
cd ~/.claude/plugins/cache/excalidraw-skills/excalidraw/1.0.0/skills/excalidraw/references
uv sync
